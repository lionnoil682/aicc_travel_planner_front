...
const Itempanel = () => {
  return (
    <div className="Itempannel_container lg:w-3/5 i13:w-full p-1 ">
      <div className="Itempannel_wrapper flex flex-col items-center  ">
        <div
        ...
        <div
          className="Itempannel_text  h-[10%] font-semibold font-gothicA1 flex gap-2 justify-end"
          style={{ width: '85%' }}
        >
